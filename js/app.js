 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (quickOrderSliders) quickOrderSliders.forEach((function(quickOrderSlider) {
                new swiper_core_Swiper(quickOrderSlider, {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
...
***************************************************************************** */
        ...
        if (cartList) {
            ...
            document.addEventListener("resize", moveElementsBasedOnScreenSize);
        }
